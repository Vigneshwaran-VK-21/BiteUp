...
function OrderPlaced() {
  ...
  return (
     ...
     <button className='bg-[#8b5cf6] hover:bg-[#6d28d9] text-white px-6 py-3 rounded-lg text-lg font-medium transition' onClick={()=>navigate("/my-orders")}>Back to my orders</button>
    </div>
  )
}
