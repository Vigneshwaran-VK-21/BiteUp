...
function ForgotPassword() {
  ...
  return (
    <div className='flex w-full items-center justify-center min-h-screen p-4 bg-[#f8f5ff]'>
        <div className='bg-white rounded-xl shadow-lg w-full max-w-md p-8'>
            <div className='flex items-center  gap-4 mb-4'>
                <IoIosArrowRoundBack size={30} className='text-[#8b5cf6] cursor-pointer' onClick={()=>navigate("/signin")}/>
                <h1 className='text-2xl font-bold text-center text-[#8b5cf6]'>Forgot Password</h1>
            </div>
            {step == 1
            && 
            <div>
                 ...
                 <button className={`w-full font-semibold py-2 rounded-lg transition duration-200 bg-[#8b5cf6] text-white hover:bg-[#6D28D9] cursor-pointer`} onClick={handleSendOtp} disabled={loading}>
            ...
            <div>
                 ...
                 <button className={`w-full font-semibold py-2 rounded-lg transition duration-200 bg-[#8b5cf6] text-white hover:bg-[#6D28D9] cursor-pointer`} onClick={handleVerifyOtp} disabled ={loading}> 
            ...
            <div>
                 ...
                 <button className={`w-full font-semibold py-2 rounded-lg transition duration-200 bg-[#8b5cf6] text-white hover:bg-[#6D28D9] cursor-pointer`} onClick={handleResetPassword}>
