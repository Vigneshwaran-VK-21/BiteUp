...
<span className='text-sm'>status: <span className='font-semibold capitalize text-[#8b5cf6]'>{data.shopOrders.status}</span>
</span>

<select  className='rounded-md border px-3 py-1 text-sm focus:outline-none focus:ring-2 border-[#6d28d9] text-[#8b5cf6]' onChange={(e)=>handleUpdateStatus(data._id,data.shopOrders.shop._id,e.target.value)}>
